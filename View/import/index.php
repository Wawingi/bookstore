                            ...
                            <div class="col-md-12">
                                ...
                                <form method="post" enctype="multipart/form-data">
                                    <div class="form-group row">
                                        <label class="col-md-2 col-form-label">Import CSV File</label>
                                            <div class="col-md-8">
                                            <input type="file" name="file" class="form-control">
                                        </div>
                                        <div class="col-2">
                                            <input type="hidden" value="import" name="operation">
                                            <button type="submit" name="import" class="btn btn-primary btn-rounded w-md waves-effect waves-light m-b-5">Import</button>
                                        </div>
                                    </div>
                                </form>
                                    <!-- Import CSV button-->
                                    <!--<a href="../import?operation=<?php echo base64_encode('import') ?>"><button type="button" class="btn btn-primary btn-rounded w-md waves-effect waves-light m-b-5" data-toggle="modal" data-target="#modalbook">Import Books</button></a>-->
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box table-responsive">
                                    <h4 class="m-t-0 header-title">My Imported Books</h4><hr><br>
